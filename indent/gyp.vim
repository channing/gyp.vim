...
" Modified By:          Channing Dai (http://www.listary.com)
" URL:			http://github.com/rogerz/vim-json
" Version:              1.0.1
" Last Change:          March 22, 2012
...
function s:IsInString(lnum, col)
  return synIDattr(synID(a:lnum, a:col, 1), 'name') == gypStringS
endfunction
...
"    let bs = strpart('{}[]', stridx('}]', line[col - 1]) * 2, 2)
    let pairline = searchpair(sb, '', line[col - 1], 'bW')
    "echom pairline " " bs[0] " " bs[1]
    if pairline > 0 
